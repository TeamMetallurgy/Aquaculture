...
public class AquaRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<FishFilletRecipe>> FISH_FILLET_SERIALIZER = registerRecipeSerializer("crafting_special_fish_fillet", FishFilletRecipe.SERIALIZER);
